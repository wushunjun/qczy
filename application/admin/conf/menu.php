...
//            array('name' => '品牌列表', 'act' => 'brandList', 'op' => 'Goods'),
    ...
    'store' => array('name' => '门店', 'child' => array(
        array('name' => '门店管理', 'child' => array(
            ...
            array('name' => '技师列表', 'act' => 'index', 'op' => 'Technician'),
        )),
        array('name' => '项目管理', 'child' => array(
            array('name' => '项目列表', 'act' => 'index', 'op' => 'Project'),
        )),
        array('name' => '摇一摇', 'child' => array(
            array('name' => '摇签列表', 'act' => 'index', 'op' => 'Shake'),
        )),
        array('name' => '今日运势', 'child' => array(
            array('name' => '素材列表', 'act' => 'index', 'op' => 'Luck'),
        )),
        array('name' => '打卡任务', 'child' => array(
            array('name' => '打卡资源', 'act' => 'index', 'op' => 'TaskResource'),
        )),
    )),
